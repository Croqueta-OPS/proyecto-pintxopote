	...
	$.ajax({
		...
		success: function(data) {
			...
			data.forEach(function(element, index, array) {			
				...
				bares += '<div id="'+element.nombre+'" class="imagenesBares"><img id="btnCambiar'+index+'" src="img/'+element.img+'_mini.jpg"></img></div>';					
